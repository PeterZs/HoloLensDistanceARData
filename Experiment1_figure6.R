## Analysis for Experiment 1 mobility - Creates Figure 6 and
...
# load data
dat = read.csv2('Data/Experiment1_mobility_task_likert_ratings.csv', sep = ',', dec = '.')
...
Figure6 = grid.arrange(p1, p2, p3, p4, ncol=2, nrow =2)
